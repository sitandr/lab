...
Так как угол $\alpha = \frac{\pi}{3}$  и мы проводили каллибровку по минимальному улу отклонения для красного цвета, получив $\theta_{red}$ можем найти $n$  для красного цвета, так как углы отличаются не сильно (3.5 градуса), то можно продолжать пользоваться приближением (угла падения и угла отражения) 
$$
