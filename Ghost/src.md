...
Так как угол $\alpha = \frac{\pi}{3}$  и мы проводили каллибровку по минимальному углу отклонения для красного цвета, получив $\theta_{red}$ можем найти $n$ для красного цвета, так как углы отличаются не сильно (3.5 градуса), то можно продолжать пользоваться приближением (угла падения и угла отражения). 
$$
n = 2 \cos (\frac{\pi}{3}-\theta/2)
$$

 Для более точного ответа, нужно брать угол падения равным $\theta_{red}/2$ и считать все преломления в системе для него.
$$
