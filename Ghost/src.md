...
Мы знаем угол $\alpha = \frac{\pi}{3}$, а также мы проводили калибровку по минимальному углу отклонения для красного цвета. Значит, получив $\theta_{red}$, можно найти $n$ для красного цвета. А так как углы отличаются не сильно (3.5 градуса), то можно продолжать пользоваться приближением (угла падения и угла отражения):
$$
