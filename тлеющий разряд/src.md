...
Что тоже интересно,  в данном эксперименте было обнаружено, что существует  интервал напряжения при котором при одинаковых условиях сохраняется пробой, но отличается подаваемое напряжение. При $7 - 13$ мБарах это было особенно заметно там различие составляло до $±200$ В.  

![](images forHonor/1.jpg){width=70%}

![](images forHonor/2.jpg){width=70%}

Для этого эксперимента (с пробоем) мы брали средние значения, возможно если бы мы брали минимальные или максимальные, то зависимость проглядывалась бы лучше.
