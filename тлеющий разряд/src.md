...
В этой работе мы изучали разряд при низких давлениях (< 2% атмосферного), малых токах ($\sim$ 2 мА) и высоких напряжениях (до 10 кВ) — то есть тлеющий разряд.
...
Если сравнить с первым экспериментом, видно, что здесь свечение выключается гораздо позже ($\sim$ 2 мБар по сравнению с $\sim$ 1 мБар в предыдущем). Также отличаются зависимости:
...
Были промерены зависимости напряжения разряда при фиксированном токе 2 мА от давления $20$ мкБар до 20 мБар. Эксперимент показал, что эта зависимость и наблюдаемое свечение неоднозначно определено и может слегка меняться в разных измерениях. На участке $20-40$ мкБар напряжение хорошо описывается функцией вида $\displaystyle{\frac A{x^3}}$, на $50-110$ мкБар — $\displaystyle{\frac{B}{x^{3/4}}}$, на давлениях $2-20$ мБар зависимость близка к линейной. Напряжение пробоя превышает напряжение в 2.0 ± 0.2 раза. Мы неоднократно наблюдали полосы в положительном свечении и обнаружили увеличение интенсивности свечения и требуемого для тока 2 мА напряжения во внешнем магнитном поле. Наблюдения по большей части согласуются с теоретической моделью.
