...
Что тоже интересно,  в данном эксперименте было обнаружено, что существует  интервал напряжения при котором при одинаковых условиях сохраняется пробой, но отличается подаваемое напряжение. При $7 - 13$ мБарах это было особенно заметно там различие составляло $±200$ В.  
