...
Это позволяет предположить, что двигатель продолжает работать, но гораздо менее эффективно, что приводит к медленному затуханию. Когда достигается ноль, двигатель начинает вращение в обратную сторону.
