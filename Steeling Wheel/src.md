...
![Торможение двигателя из-за запуска системы в обратном направлении](img/Оборотень.png){width=70%}
...
Более того, приближение КПД процесса работы двигателя через изотермы дает результат, далекий от наблюдаемого. В реальности в силу разных причин (не только термодинамических), КПД по нашим оценкам снижается примерно ещё в 30 раз.
