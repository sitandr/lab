...
Тогда $ΔT≈100$ К, откуда $η$ мы можем оценить подставив объёмы из справочных данных к аппарату $\frac{V_1}{V_0} = \frac{23}{22} и V_0 = 330 \mbox{см}^3$
$$
...
![Торможение системы без подвода тепла](img/Тормоз.png){width=70%}
...
![Работа двигателя без нагрузки (1)](img/Крут_1.png){width=70%}

![Работа двигателя без нагрузки (2)](img/Крут_2.png){width=70%}

![Работа двигателя без нагрузки (3)](img/Крут_3.png){width=70%}
...
![Работа двигателя с нагрузкой 25гр (1)](img/η2.png){width=70%}

![Работа двигателя с нагрузкой 25гр (2)](img/η3.png){width=70%}

![Работа двигателя с нагрузкой 25гр (3)](img/η.png){width=70%}
...
$$
M = \frac{mgr}{2\pi(\dot ν_2 - \dot ν_3)}≈\frac{mgr}{2\pi\dot ν_2}≈\frac{0.025·9.8·0.01}{2·3.14·0.025} ≈ 0.0156 (\mbox{кг·м}^2)
$$
...
![Сравнение работ двигателя без нагрузки при разных подаваемых мощностях (1)](img/coords.png){width=70%}
...
![Сравнение работ двигателя без нагрузки при разных подаваемых мощностях (1)](img/speeds.png){width=70%}
...
![Торможение двигателя из-за запуска системы в обратном напрвлении](img/Оборотень.png){width=70%}
...
![ускорение двигателя без подачи тепла при прикладывании постоянного момента силы](img/Падение.png){width=70%}

Этот эксперимент - аналог первой серии и был проведён одним из первых для проверки двигателя на существенность силы трения. Так как ускорение системы оказалось в 2 раза выше чем её замедление в первой серии (с учётом торможения в этом эксперименте), то пожно оценить силу трения как mg, гре m = 25гр
...
В результате было выяснено, что метод протыкивания вращений - не очень хорош, так как человек может буквально не попасть по кнопке. Для улучшения последствий этой ошибки - хорошей идеей будет также записывать суммарное число оборотов за время измерения, для восстановления этих точек.
