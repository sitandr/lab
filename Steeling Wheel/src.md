...
$$
η_1 = \frac{mg ω_2 r + Mω_2 \dot ω_2 + P_f(ω_2)}{UI} = \frac{2\pi mg ν_3 r + 4\pi^2 M ν_3 \dot ν_3 + P_f(ν_3)}{UI}\\
η_2 = \frac{Mω_1 \dot ω_1 + P_f(ω_1)}{UI} = \frac{4\pi^2Mν_2\dot ν_2 + P_f(ν_2)}{UI}\\
$$
...
$$
η_{full} = \frac{2\pi mgrν_2 \dot ν_2}{(\dot ν_2 - \dot ν_3) UI} = 4\pi^2 M \frac{ν_2\dot ν_2 }{UI}
$$
...
В целом видно, что $ν_3'$ в нашем случае мала
