...
КПД установок в таком случае должны быть равны при одинаковых угловых скоростях (угловые ускорения - разные).  Тогда:
$$
\frac{2\pi mg ν_2 r + 4\pi^2 M ν_2 \dot ν_2 + P_f(ν_2)}{UI}= η_2 = \frac{4\pi^2Mν_2\dot ν_1 + P_f(ν_2)}{UI}\\
$$
...
$$
P_f(ν_1) = 4\pi^2 Mν_0 \dot ν_0 = 2\pi \frac{mgr}{\dot ν_1 - \dot ν_2}ν_0 \dot ν_0
$$
Имея этот момент инерции и мощность затухания нетрудно посчитать КПД тепловой машины от частоты:
$$
η_2 = \frac{\frac{2\pi mgr}{\dot ν_1 - \dot ν_2}ν_1\dot ν_1 + 2\pi \frac{mgr}{\dot ν_1 - \dot ν_2}ν_1 \dot ν_0}{UI}\\
η_2 = \frac{2\pi mgrν_1 (\dot ν_1 + \dot ν_0)}{(\dot ν_1 - \dot ν_2) UI}\\
$$


И если нам нужно узнать КПД двигателя с учётом его механического несовершенства, то:
$$
η_2 = \frac{2\pi mgrν_1 \dot ν_1}{(\dot ν_1 - \dot ν_2) UI}\\
$$
