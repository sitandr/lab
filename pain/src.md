...
Нетрудно заметить, что $ΔP$ будет порядка $500 \mbox{ Па} \ll P_a$. Значит, в показателе адиабаты множитель $P$ можно заменить на $P_a$. Тогда показатель адиабаты равен:
$$
