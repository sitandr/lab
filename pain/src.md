...
В результате мы получили, что показатель адиабаты для обоих газов практически совпал ($χ≈1.32$). Что отличается от табличных данных показателей адиабаты для воздухи и углекислого газа.
