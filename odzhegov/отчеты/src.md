...
![Камера, направленная на лампу на потолке](../photo/1/image_2023-02-21T16-23-18.038.png)
...
![Фиолетовые "обои" рабочего стола на цветной камере](../photo/Фотки с моего компа/image_2023-02-21T18-06-09.365.png)
...
![Спектр белой части монитора ноутбука](../measure/white screen.jpg){width=50%}
...
![Полный вид NBS1963A](../../../../../AppData/Roaming/Typora/typora-user-images/image-20230410215534443.png){width=50%}
