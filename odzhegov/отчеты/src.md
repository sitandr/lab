...
![Зелёный светодиод](../photo/3/image_2023-03-07T16-57-33.267.bmp)

![Синий светодиод](../photo/3/image_2023-03-07T16-49-51.775.bmp)
...
Для расчета ожидаемого разрешения воспользуемся формулой Релея:
$$
δ = \frac{0.61λ}{NA}
$$
Оценим $NA$ для 
