...
К сожалению, оставшееся время лабораторной мы потратили на то попытку заставить программное обеспечение "увидеть" спектрометр. Как оказалось, проблема возникла в том, что одна и та же по сути программа имелась в нескольких "вариантах" для спектрометров разной модели. 
...
![Лампа с фильтром Скотта](../measure/Schott-glass filter halogen lamp.jpg)
...
- Линза большой оптической силы (…), "превращающая" точечное изображение на образце в параллельный пучок

- Камера с трубкой длины 3'' и линзой на (…), настроенная на бесконечность — если направить трубку с линзой на далёкий объект, на камере должно быть чёткое изображение.

После этого мы занялись настройкой камеры, прикрутив объектив с линзой, и взяв за ориентир расположенное достаточно далеко (не менее нескольких сотен метров) здание, мы постарались получить наиболее чёткое изображение верхних окон, изменяя расстояние от камеры до линзы.
