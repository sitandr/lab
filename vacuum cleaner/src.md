...
А исходя из 1 эксперимента, где мы рассматривали малую систему с 2 соединениями, (в ней можно считать давление в системе постоянным).
$$
2c_1 P_{atm} = с_2 P_1
$$
Проверим корректность этого вывода:
$$
c_1 = \frac{с_2 P_1}{2P_{atm}}  \\
 2 * 80 * 10^{-2} - = 2 (P_3 - (P_4 - P_3) \frac{l}{L})  = 5P_1 = 5 * 4 *10^{-3}
$$
