...
![схема установки №3, конфигурация 1](img/pic_3.jpg){width=70%}
...
$$
Так как откачка происходит в одном месте, то распределение давления должно быть линейным (в зависимости от расстояния до насоса). Тогда для любого поперечного сечения трубки входящий поток должен быть равен выходящему, рассмотрим самый прогнозируемый случай (3 и 4). В этой системе у нас есть 5-6 соединений в которых происходит набор воздуха: 2 между трубками, 1 между трубкой и шлангом, 1 на манометре, и на 1-2 на задвижке. Расстояние до первых 4-5 сильно меньше расстояния до последнего. В таком случае можно считать Рассмотрим 3-ий случай.
$$
c_2 P/L
$$
