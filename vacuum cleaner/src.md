...
$$
P_{pump} = P_p = \lim\limits_{t \rightarrow \inf} P_3 - (P_4 - P_3) \frac{l}{L} = c(P_3 - (P_4 - P_3))\\ 
...
Это интересный результат, но неверный стоит проверить формулу с помощью 5 схемы.
$$
...
Но даже не смотря на это результат отличается менее чем на порядок от реальности, что является неплохой оценкой.
## Выводы
...
Мы смогли привести качественные оценки происходящего совпадающие с реальными по порядку величины, а где-то намного точнее.