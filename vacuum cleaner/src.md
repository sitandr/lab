...
![5567](img/5567.png)![build_2](img/build_2.png)

![I](img/I.png)

![nothing](img/nothing.png)

Мы планировали поработать с результатами аппроксимаций, но из-за жестких временных рамок не успели это сделать. Далее мы приведем только достаточно простые рассуждения, а более глубокий анализ экспериментально полученных данных оставим как тему для отдельного исследования. 
