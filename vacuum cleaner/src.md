...
$$
\frac{dP}{dt} = \frac{dP_{in}}{dt} - \frac{dP_{out}}{dt} = c1 * (P_{atm}- P) - \frac{dn}{dt}*kT
$$
Так как $\frac{dn}{dt}$ линейно зависит от давления, то:
$$
\frac{dP}{dt} =  c1 * (P_{atm}- P) - с_2P = c - aP
$$

Но если углубиться ещё глубже, воздух попадающий в систему - проходит в неё в разных точках, с разными давлениями, в зависимости от расстояния до насоса. $N$ - количество стыков, $P_i$ давление газа внутри на этом стыке		
$$
\frac{dP}{dt} = \sum_{i=1}^{N} c1 * (P_{atm}- P_i) - с_2P =
$$
